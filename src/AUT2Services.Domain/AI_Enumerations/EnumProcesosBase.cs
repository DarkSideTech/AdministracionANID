...
public static class EnumProcesosBase
{
    public const string ADMINISTRACION = nameof(ADMINISTRACION);

    public static IList<string> ObtenerListaValores()
    {
        return EnumUtils.GetAllPublicConstantValues<string>(typeof(EnumProcesosBase));
    }
}
