...
public class ModificarAutenticadorExternoCommand : AutenticadorExternoCommand
{
    public ModificarAutenticadorExternoCommand(
        Guid id, 
    ...
    {
        CommandResponse.ValidationResult = new ModificarAutenticadorExternoCommandValidations().Validate(this);
