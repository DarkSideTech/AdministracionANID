...
// Date Generated File : 2026-04-05 15:14:10.185
// -------------------------------------------------
...
namespace AUT2Services.Domain.Commands.Procesos.Handlers
{
    public partial class ProcesoCommandHandler :
        IRequestHandler<DesactivarProcesoCommand, CommandResponse>
    {
        public async Task<CommandResponse> Handle(DesactivarProcesoCommand command, CancellationToken cancellationToken)
        {
        ...
        {
            AddError($"El Proceso ya se encuentra desactivado");
            return CommandResponse;
        }

        newProceso.CambiarActivo(false);

            AddUpdateDomainEvent(command, newProceso, new ProcesoEventDesactivada(
                    newProceso.Id, 
                    newProceso.Activo 
