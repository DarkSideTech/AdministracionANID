...
// Date Generated File : 2026-04-05 15:14:10.118
// -------------------------------------------------
...
namespace AUT2Services.Domain.Commands.Proveedores.Handlers
{
    public partial class ProveedorCommandHandler :
        IRequestHandler<ModificarProveedorCommand, CommandResponse>
    {
        public async Task<CommandResponse> Handle(ModificarProveedorCommand command, CancellationToken cancellationToken)
        {
