...
// Date Generated File : 2026-04-05 15:14:10.111
// -------------------------------------------------
...
public abstract class ProveedorValidations<T> : AbstractValidator<T> where T : ProveedorCommand
{
    ...
    protected void Validate_Descripcion()
    {
        RuleFor(rf => rf.Descripcion)
            ...
            .Length(3, 500) 
                .WithMessage("El valor ingresado debe contener entre 3 y 500 caracteres"); 
    } 

    protected void Validate_APIDeAutenticacion()
    {
        RuleFor(rf => rf.APIDeAutenticacion)
            .NotEmpty() 
                .WithMessage("El valor ingresado para el campo APIDeAutenticacion no puede estar vacio"); 
    } 

    protected void Validate_ProveedorBase()
    {
        RuleFor(rf => rf.ProveedorBase)
