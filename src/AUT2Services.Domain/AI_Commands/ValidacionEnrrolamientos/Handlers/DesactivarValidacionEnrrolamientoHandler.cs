...
namespace AUT2Services.Domain.Commands.ValidacionEnrrolamientos.Handlers
{
    public partial class ValidacionEnrrolamientoCommandHandler :
        IRequestHandler<DesactivarValidacionEnrrolamientoCommand, CommandResponse>
    {
        public async Task<CommandResponse> Handle(DesactivarValidacionEnrrolamientoCommand command, CancellationToken cancellationToken)
        {
            ...
            newValidacionEnrrolamiento.CambiarActivo(false);

            AddUpdateDomainEvent(command, newValidacionEnrrolamiento, new ValidacionEnrrolamientoEventDesactivado(
