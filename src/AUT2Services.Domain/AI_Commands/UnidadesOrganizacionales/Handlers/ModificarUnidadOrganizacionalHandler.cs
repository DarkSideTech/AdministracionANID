...
namespace AUT2Services.Domain.Commands.UnidadesOrganizacionales.Handlers
{
    public partial class UnidadOrganizacionalCommandHandler :
        IRequestHandler<ModificarUnidadOrganizacionalCommand, CommandResponse>
    {
        public async Task<CommandResponse> Handle(ModificarUnidadOrganizacionalCommand command, CancellationToken cancellationToken)
        {
            ...
            AddUpdateDomainEvent(command, newUnidadOrganizacional, new UnidadOrganizacionalEventModificado(
