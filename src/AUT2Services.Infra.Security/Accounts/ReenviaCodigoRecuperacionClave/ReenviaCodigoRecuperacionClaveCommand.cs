...
public class ReenviaCodigoRecuperacionClaveCommand : Command
{
    ...
    {
        CommandResponse.ValidationResult = new ReenviaCodigoRecuperacionClaveCommandValidations().Validate(this);
