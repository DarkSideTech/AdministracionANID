...
public sealed class PasswordChangeChallengeConfiguration : IEntityTypeConfiguration<PasswordChangeChallenge>
{
    public void Configure(EntityTypeBuilder<PasswordChangeChallenge> builder)
    {
        ...
        builder.Property(entity => entity.ChallengePurpose)
            .HasMaxLength(50)
            .HasDefaultValue(PasswordChangeChallengePurposes.PasswordChange)
            .IsRequired();
        ...
        builder.HasIndex(entity => new { entity.UserId, entity.ChallengePurpose, entity.ExpiresAtUtc, entity.ConsumedAtUtc, entity.CancelledAtUtc });
    }
}
