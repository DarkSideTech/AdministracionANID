        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaveDeAcceso = table.Column<string>(type: "text", nullable: false),
                    NombreADesplegar = table.Column<string>(type: "text", nullable: false),
                    ValidadorPrimario = table.Column<bool>(type: "boolean", nullable: false),
                    AutenticadorExternoBase = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Id_UnidadOrganizacional = table.Column<Guid>(type: "uuid", nullable: false),
                    Id_Usuario = table.Column<Guid>(type: "uuid", nullable: false),
                    TipoDeEntidad = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    CorreoElectronico = table.Column<string>(type: "text", nullable: false),
                    FechaInicioAutorizacion = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    FechaTerminoAutorizacion = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    FechaCreacion = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    Principal = table.Column<bool>(type: "boolean", nullable: false),
                    EntidadBase = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    IdOrganizacion = table.Column<string>(type: "text", nullable: false),
                    Codigo = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Nombre = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    Descripcion = table.Column<string>(type: "text", nullable: false),
                    OrganizacionBase = table.Column<bool>(type: "boolean", nullable: false),
                    Activo = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id_Proceso = table.Column<Guid>(type: "uuid", nullable: false),
                    FechaInicioAsignacion = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    FechaTerminoAsignacion = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    FechaCreacion = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    RolRequiereValidacion = table.Column<bool>(type: "boolean", nullable: false),
                    RolAsignadoValidado = table.Column<bool>(type: "boolean", nullable: false),
                    PoliticaAsignadaBase = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    IdMacro_Proceso = table.Column<Guid>(type: "uuid", nullable: false),
                    Codigo = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Nombre = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    Descripcion = table.Column<string>(type: "text", nullable: false),
                    Contexto = table.Column<string>(type: "text", nullable: false),
                    NivelDeProceso = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Url = table.Column<string>(type: "text", nullable: false),
                    Token = table.Column<string>(type: "text", nullable: false),
                    ComoDesplegarUrlDeProceso = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ProcesoBase = table.Column<bool>(type: "boolean", nullable: false),
                    MaximaAsignacionDeRoles = table.Column<int>(type: "integer", nullable: false),
                    Activo = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    APIDeAutenticacion = table.Column<string>(type: "text", nullable: false),
                    ProveedorBase = table.Column<bool>(type: "boolean", nullable: false),
                    Activo = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiereAccionParaSerAsignado = table.Column<bool>(type: "boolean", nullable: true),
                    ActivaDetalleDeAutorizaciones = table.Column<bool>(type: "boolean", nullable: true),
                    RequiereValidacionDeAsignacion = table.Column<bool>(type: "boolean", nullable: true),
                    ValidaAsignacionDeRoles = table.Column<bool>(type: "boolean", nullable: true),
                    ValidaEnrrolamiento = table.Column<bool>(type: "boolean", nullable: true),
                    RolBase = table.Column<bool>(type: "boolean", nullable: true),
                    ...
                    NombreNormalizado = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    Descripcion = table.Column<string>(type: "text", nullable: false),
                    UnidadOrganizacionalBase = table.Column<bool>(type: "boolean", nullable: false),
                    Activo = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdPersona = table.Column<string>(type: "text", nullable: true),
                    NombreADesplegar = table.Column<string>(type: "text", nullable: true),
                    Descripcion = table.Column<string>(type: "text", nullable: true),
                    TipoDeUsuario = table.Column<string>(type: "text", nullable: true),
                    Activo = table.Column<bool>(type: "boolean", nullable: true),
                    UsuarioBase = table.Column<bool>(type: "boolean", nullable: true),
                    RequiereValidacionEnrrolamiento = table.Column<bool>(type: "boolean", nullable: true),
                    EstadoDeUsuario = table.Column<string>(type: "text", nullable: true),
                    ...
                    NombreUsuario = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    NombreUsuarioNormalizado = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    CorreoElectronico = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    CorreoElectronicoNormalizado = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    CorreoElectronicoConfirmado = table.Column<bool>(type: "boolean", nullable: false),
                    HashDeLaClave = table.Column<string>(type: "text", nullable: true),
                    SecurityStamp = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "text", nullable: true),
                    NumeroDeTelefono = table.Column<string>(type: "text", nullable: true),
                    NumeroDeTelefonoConfirmado = table.Column<bool>(type: "boolean", nullable: false),
                    DobleFactorHabilitado = table.Column<bool>(type: "boolean", nullable: false),
                    LockoutEnd = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    LockoutEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    CantidadDeAccesosFallidos = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    IdValidado_Usuario = table.Column<Guid>(type: "uuid", nullable: false),
                    IdValidaEnrrolamiento_Usuario = table.Column<Guid>(type: "uuid", nullable: false),
                    EnrrolamientoAceptado = table.Column<bool>(type: "boolean", nullable: false),
                    FechaValidacion = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("ecaf1074-722d-468f-81fa-69c2d7b88d68"), true, true, "AQAAAAIAAYagAAAAEL23Xp7j+JxUsrKAljUnZ89wxmX/rYfRl8mrMVy20i8pAO1tng9S7zJYwpOucvcyrg==", new Guid("701c19bf-405c-4467-85f0-ddbc3786f9ee"), new Guid("2b12d04f-c167-4ad1-a42a-e2ecd30518d7"), "ADMINISTRADOR", "ADMINISTRADOR", true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), "", true, new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("198c164d-1cd8-4107-9db3-74b9fa33302c"), new Guid("2b12d04f-c167-4ad1-a42a-e2ecd30518d7"), true, "PERSONA" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb55"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("d1889c7c-c5dc-4d9a-a2fe-34cdf956b145"), new Guid("856a08fd-4162-47cb-bf92-ff25029f3546"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb56"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("fcd2dcf8-7230-4fdd-9651-b4efeb60d11f"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb57"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("eec159f1-9ba9-463d-8407-ec2951751c29"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb58"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("4bb69d17-cc38-4e52-ad36-42226aa5723d"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb59"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("35e9a345-dda9-45fc-9a35-7cf27ec8e947"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb5a"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("06001a21-9b5f-47a3-ae8b-c749e531f9b1"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb5b"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("e256405c-0bda-479a-8a41-a043c672f9b1"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb5c"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("2b597b09-55ad-4304-b57d-76bd2df5ac4c"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb5d"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("0737dfc9-8c0f-44ed-ada9-0d227d6a4b5c"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb5e"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("aeaeb19b-2206-4870-9a99-f5d40a982b2e"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb5f"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("f2224186-ffcc-41ee-bbce-4bbd72504e22"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb60"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("f3285b94-90a4-4610-8c65-2782d2e3a1a3"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("60838d42-c2df-402c-9253-ab3ce52ffb61"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("e150709d-4fed-480b-8916-8b0837a775d3"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("8f589ba2-3bc0-40ea-b7c2-7aaaee278d6d"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("d1889c7c-c5dc-4d9a-a2fe-34cdf956b145"), new Guid("c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e"), true, true, false },
                    { new Guid("bf05f4af-4bbc-472f-a7ed-bbd6d5d1af61"), new DateTimeOffset(new DateTime(2026, 4, 7, 23, 4, 30, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, null, new Guid("05507441-5792-4c46-9334-9a5faa99e20a"), new Guid("d1889c7c-c5dc-4d9a-a2fe-34cdf956b145"), new Guid("03b6b706-a24f-4505-9ef6-e3ae7d48c907"), true, true, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "03b6b706-a24f-4505-9ef6-e3ae7d48c907", false, true, "4f4d7775-2677-47e7-8ccd-a34f5d002004", "", "VALIDA_ASIGNACION_ROLES", "VALIDA_ASIGNACION_ROLES", true, false, true, false, false },
                    { "36957ec2-2857-4101-a81b-f0340bf8eff2", false, true, "4f4d7775-2677-47e7-8ccd-a34f5d002002", "", "ADMINISTRADOR_ENTIDAD", "ADMINISTRADOR_ENTIDAD", true, false, true, false, false },
                    { "856a08fd-4162-47cb-bf92-ff25029f3546", false, true, "4f4d7775-2677-47e7-8ccd-a34f5d002005", "", "VALIDA_ENRROLAMIENTO", "VALIDA_ENRROLAMIENTO", true, false, true, false, false },
                    { "c42e4c85-2b6d-4c8f-8672-f82a2d1c2d9e", false, true, "4f4d7775-2677-47e7-8ccd-a34f5d002001", "", "ADMINISTRADOR", "ADMINISTRADOR", true, false, true, false, false },
                    { "e198ec28-2b1b-48b0-8d5e-eb946d596e90", false, true, "4f4d7775-2677-47e7-8ccd-a34f5d002006", "", "USUARIO", "USUARIO", false, false, true, false, false },
                    { "e3093727-b36b-45af-a495-7c3d0804c0e9", false, true, "4f4d7775-2677-47e7-8ccd-a34f5d002003", "", "ADMINISTRADOR_UNIDAD", "ADMINISTRADOR_UNIDAD", true, false, true, false, false }
                });
